	...
	<div id="depot_avis">
		<form action="script_depot_avis.php" method="POST">
			...
			<table id="note">
				...
				<tr><td class="label">Note de la localistaion : <span class="interrogation" data-descr="Pensez à prendre en considération l'accessibilité au site et l'environnement du site.">?</span></td><td><input class="note" type="number" name="note_localisation" min="0" max="5" step="0.5" placeholder=" /5" pattern="[0-5](\.5)?" title="Note de la localisation" required></td></tr>
