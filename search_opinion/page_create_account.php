...
<body>
	...
	<div id="create_account">
		<form action="script_create_account.php" method="POST" >
			...
			<div><label><div class="label">Mot de passe : <span class="interrogation" data-descr="Nous vous conseillons de ne pas utiliser un même mot de passe sur plusieurs sites. Sont acceptés les caractères alphanumériques et : ?!-.@+*$#&_:">?</span></div><input class="formule" type="password" name="mdp" id="mdp" placeholder="Mot de passe" title="Créez un mot de passe" oncopy="return false" oncut="return false" maxlength="25" pattern="^[a-zA-Z0-9\?\!\@\+\*\$\&\_\:\.\-\#]{4,25}$" required></label></div>
			<div><label><div class="label">Confirmation mot de passe : </div><input class="formule" type="password" name="mdp_verif" id="mdp_verif" placeholder="Recopiez votre mot de passe" title="Confirmer votre mot de passe" onpast="return false" pattern="^[a-zA-Z0-9\?\!\@\+\*\$\&\_\:\.\-\#]{4,25}$" required></label></div>
	...
	<script type="text/javascript">
		...
		//Send the name and surname with the form
